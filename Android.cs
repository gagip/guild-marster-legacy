...
public class Android : MonoBehaviour
{
    ...
    string DatabaseName = "Hunters.db";
    ...
    void Start()
    {
        ...
        if (!File.Exists(filepath))
        {
            ...
            Debug.LogWarning("File \"" + filepath + "\" does not exist. Attempting to create from \"" +
                             Application.dataPath + "!/assets/StreamingAssets/Hunters");



            // UNITY_ANDROID
            WWW loadDB = new WWW("jar:file://" + Application.dataPath + "!/assets/StreamingAssets/Hunters.db");
            while (!loadDB.isDone) { }
